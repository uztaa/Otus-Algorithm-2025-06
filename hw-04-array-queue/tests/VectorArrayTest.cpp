...
TEST(VectorArrayTest, InitiallyEmpty) {
    VectorArray<int> array;
    EXPECT_EQ(array.size(), 0);
}

TEST(VectorArrayTest, AddElementsToFront) {
    VectorArray<int> array;
    array.add(10, 0);
    array.add(20, 0);
    array.add(30, 0);
...
TEST(VectorArrayTest, AddElementsToEnd) {
    VectorArray<int> array;
    array.add(10, 0);
    array.add(20, 1);
    array.add(30, 2);
...
TEST(VectorArrayTest, AddElementsToMiddle) {
    VectorArray<int> array;
    array.add(10, 0);  // [10]
...
TEST(VectorArrayTest, RemoveElements) {
    VectorArray<int> array;
    array.add(1, 0);
    array.add(2, 1);
    array.add(3, 2);  // [1, 2, 3]
...
TEST(VectorArrayTest, RemoveFromFrontAndEnd) {
    VectorArray<int> array;
    array.add(1, 0);
    array.add(2, 1);
    array.add(3, 2);
...
TEST(VectorArrayTest, GetInvalidIndexThrows) {
    VectorArray<int> array;
    array.add(1, 0);
...
TEST(VectorArrayTest, AddInvalidIndexThrows) {
    VectorArray<int> array;
    EXPECT_THROW(array.add(1, -1), std::out_of_range);
    EXPECT_THROW(array.add(1, 2), std::out_of_range);
}

TEST(VectorArrayTest, RemoveInvalidIndexThrows) {
    VectorArray<int> array;
